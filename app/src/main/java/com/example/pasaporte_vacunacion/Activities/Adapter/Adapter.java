package com.example.pasaporte_vacunacion.Activities.Adapter;
...
import com.example.pasaporte_vacunacion.Activities.Utils;
...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public Adapter(ArrayList<Article> articles, Context context){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holders, int position) {
        ...
        holder.title.setText(" \u2022 " + Utils.DateToTimeFormat(model.getPublishedAt()));
